...
KohakuTerrarium 是一個用來建構真正代理的框架，而不只是 LLM 包裝器。
...
- [Terrariums](guides/terrariums.md)：多生物連接與特權節點。
...
- [Multi-agent](concepts/multi-agent/README.md)：terrarium、特權節點、動態圖、channel topology。
...
- [v1.3.0 發布說明](reference/release-notes-1.3.0.md)：最終 changelog、相容性說明、發布流程與驗證摘要。
