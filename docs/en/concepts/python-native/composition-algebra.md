...
`compose/agent.py` wraps agents into runnables.
...
- **Ensembles.** `(fast & deep) >> pick_best` runs two agents in
...
- [kohakuterrarium.compose in reference/python.md](../../reference/python.md): full API.
