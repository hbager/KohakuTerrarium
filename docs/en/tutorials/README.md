...
single capability and walks it end-to-end. Read one per sitting; run the
commands as you go.

Guides answer focused "how do I do X" questions. Reference pages are
lookup. Concept docs explain why things are shaped the way they are.
Tutorials are the bridge: a concrete build that makes one idea click.
