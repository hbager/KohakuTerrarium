...
| ------------- | --------------- | ----- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `__init__.py` | (none) |:     | (none) | Catalog (`register_user_command`, `get_builtin_user_command`, `list_builtin_user_commands`); imports every command to trigger registration |
| `help.py`     | `/help`         | INPUT | `h`, `?`     | List available commands (`ui_list` payload)                                                                                                |
| `exit.py`     | `/exit`         | INPUT | `quit`, `q`  | Graceful shutdown (`ui_confirm`)                                                                                                           |
| `clear.py`    | `/clear`        | AGENT | (none) | Wipe conversation context; emit `context_cleared` event (`ui_confirm` + `ui_notify`)                                                       |
| `compact.py`  | `/compact`      | AGENT | (none) | Trigger manual context compaction now (`ui_notify`)                                                                                        |
