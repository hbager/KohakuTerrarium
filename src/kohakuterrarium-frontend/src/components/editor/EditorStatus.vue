...
const activeModel = computed(() => (chat.activeTab && chat.modelByTab[chat.activeTab]) || {})
const maxContext = computed(() => activeModel.value.maxContext || 0)
...
const compactThreshold = computed(() => activeModel.value.compactThreshold || 0)
