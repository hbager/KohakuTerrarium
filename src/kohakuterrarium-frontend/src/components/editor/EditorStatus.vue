    ...
    <div class="flex-1 overflow-y-auto p-2 text-xs">
      ...
      <div v-if="activeTab === 'session'" class="flex flex-col gap-1.5">
        ...
        <template v-if="instance?.type === 'terrarium'">
          ...
          <div v-for="c in instance.creatures" :key="c.name" class="flex items-center gap-1.5 px-1 cursor-pointer hover:bg-warm-100 dark:hover:bg-warm-800 rounded" @click="chat.openTab(c.name)">
          ...
          <div v-for="ch in instance.channels || []" :key="ch.name" class="flex items-center gap-1.5 px-1 cursor-pointer hover:bg-warm-100 dark:hover:bg-warm-800 rounded" @click="chat.openTab('ch:' + ch.name)">
