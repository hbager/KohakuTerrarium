...
const firstStyle = computed(() => (props.node.direction === "horizontal" ? { width: ratio.value + "%", height: "100%" } : { height: ratio.value + "%", width: "100%" }))

const secondStyle = computed(() => (props.node.direction === "horizontal" ? { width: 100 - ratio.value + "%", height: "100%" } : { height: 100 - ratio.value + "%", width: "100%" }))

const handleClass = computed(() => (props.node.direction === "horizontal" ? "w-[3px] cursor-col-resize hover:bg-iolite/30 active:bg-iolite/50" : "h-[3px] cursor-row-resize hover:bg-iolite/30 active:bg-iolite/50"))
